...
module UsageMeter
  ...
  class EventLog < ApplicationRecord
    belongs_to :customer, class_name: 'UsageMeter::Customer', foreign_key: 'usage_meter_customer_id',
                          inverse_of: :event_logs, optional: false
    belongs_to :event_type, class_name: 'UsageMeter::EventType', foreign_key: 'usage_meter_event_type_id',
                            inverse_of: :event_logs, optional: false
